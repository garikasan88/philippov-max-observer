...
def apply_request_match_v21_production_overlay(src: str) -> str:
    ...
    - loading the V2.1 real-request JS hardening layer;
    ...
    cmd_new = '''          python3 - "$SRC" "$WORKDIR" "$GITHUB_WORKSPACE/src/request_match_v2_patch.js" "$GITHUB_WORKSPACE/src/request_match_v2_hotfix.js" "$GITHUB_WORKSPACE/src/request_match_v21_real_requests_hotfix.js" <<'PY' '''.rstrip()
